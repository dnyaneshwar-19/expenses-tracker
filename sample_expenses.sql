...
INSERT INTO expense (title, amount, description, date, category, payment_method, expense_type, is_pinned, user_id) 
VALUES
...
-- --- Budgets for August 2025 ---
INSERT INTO budget (category, limit_amount, start_date, end_date, user_id) 
VALUES
('Food', 2500, '2025-08-01', '2025-08-31', @my_user_id),       -- OVER (Spent: 2750)
('Entertainment', 8000, '2025-08-01', '2025-08-31', @my_user_id), -- UNDER (Spent: 7200)
('Business', 8000, '2025-08-01', '2025-08-31', @my_user_id),    -- OVER (Spent: 8500)
('Education', 15000, '2025-08-01', '2025-08-31', @my_user_id),  -- UNDER (Spent: 12000)
('Bills', 14000, '2025-08-01', '2025-08-31', @my_user_id),    -- OVER (Spent: 15000)
('Healthcare', 3000, '2025-08-01', '2025-08-31', @my_user_id);  -- UNDER (Spent: 2000)

-- --- Budgets for September 2025 ---
INSERT INTO budget (category, limit_amount, start_date, end_date, user_id) 
VALUES
('Food', 3000, '2025-09-01', '2025-09-30', @my_user_id),     -- UNDER (Spent: 2800)
('Education', 1500, '2025-09-01', '2025-09-30', @my_user_id),  -- OVER (Spent: 1800)
('Business', 4000, '2025-09-01', '2025-09-30', @my_user_id),   -- UNDER (Spent: 3500)
('Shopping', 1000, '2025-09-01', '2025-09-30', @my_user_id),  -- OVER (Spent: 1100)
('Bills', 1000, '2025-09-01', '2025-09-30', @my_user_id),    -- UNDER (Spent: 799)
('Entertainment', 250, '2025-09-01', '2025-09-30', @my_user_id); -- OVER (Spent: 299)

-- --- Budgets for October 2025 ---
INSERT INTO budget (category, limit_amount, start_date, end_date, user_id) 
VALUES
('Food', 3000, '2025-10-01', '2025-10-31', @my_user_id),          -- OVER (Spent: 3080)
('Entertainment', 3000, '2025-10-01', '2025-10-31', @my_user_id), -- OVER (Spent: 3650)
('Shopping', 8000, '2025-10-01', '2025-10-31', @my_user_id),      -- UNDER (Spent: 6500)
('Bills', 1500, '2025-10-01', '2025-10-31', @my_user_id),       -- UNDER (Spent: 1399)
('Business', 7500, '2025-10-01', '2025-10-31', @my_user_id),      -- OVER (Spent: 7700)
('Healthcare', 2000, '2025-10-01', '2025-10-31', @my_user_id);   -- UNDER (Spent: 1450)


SET @my_user_id = 3;

-- --- 5 Bills for August 2025 ---
-- (Next due dates are set in the future, implying Aug/Sep/Oct payments were 'paid')
INSERT INTO recurring_bill 
(name, amount, category, frequency, next_due_date, day_of_month_due, reminder_days_before, reminder_hour, reminder_minute, description, user_id) 
VALUES
